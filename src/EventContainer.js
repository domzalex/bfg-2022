    ...
    return (
        <>
            <div className="event-container">
                <div ref={eventToggleBackground} className="event-header-background"></div>
                <div ref={mainHeader} className="main-event-header">
                    <h1 onClick={toggleWeekly} className="weekly-title">Weekly Events</h1>
                    <h1 onClick={toggleMain} className="main-title">Main Calendar</h1>
                </div>
